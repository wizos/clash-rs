...
mod tests {
    ...
    async fn test_sniff_from_stream() {
        ...
        // Test data with SNI
        let client_hello_with_sni = vec![
            0x16, 0x03, 0x01, 0x00, 0x70, 0x01, 0x00, 0x00, 0x6c, 0x03, 0x03, 0x00,
            0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0a, 0x0b, 0x0c,
            0x0d, 0x0e, 0x0f, 0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17, 0x18,
            0x19, 0x1a, 0x1b, 0x1c, 0x1d, 0x1e, 0x1f, 0x00, 0x00, 0x02, 0x00, 0x2f,
            0x01, 0x00, 0x00, 0x17, 0x00, 0x00, 0x00, 0x13, 0x00, 0x11, 0x00, 0x00,
    ...
    fn test_extract_sni_tls_versions() {
        ...
        // Test TLS 1.0
        let tls_10 =
            create_client_hello((0x03, 0x01), (0x03, 0x01), "tls10.example.com");
        ...
        // Test TLS 1.1
        let tls_11 =
            create_client_hello((0x03, 0x02), (0x03, 0x02), "tls11.example.com");
        ...
        // Test TLS 1.2
        let tls_12 =
            create_client_hello((0x03, 0x03), (0x03, 0x03), "tls12.example.com");
        ...
        let tls_13 =
            create_client_hello((0x03, 0x03), (0x03, 0x03), "tls13.example.com");
    ...
    async fn setup_proxy_and_capture_client_hello(
        ...
        let cert_params =
            CertificateParams::new(vec![test_hostname.to_string()]).unwrap();
        ...
        tokio::spawn(async move {
            if let Ok((mut client_stream, _)) = proxy_listener.accept().await {
                if let Ok(mut server_stream) =
                    tokio::net::TcpStream::connect(https_addr).await
                {
    ...
    async fn test_sniff_from_http_proxy() {
        ...
        assert!(
            !captured.is_empty(),
            "Proxy should have captured ClientHello data"
        );
        ...
        assert!(
            result.is_ok(),
            "SNI extraction should succeed on proxy-captured data"
        );
    ...
    async fn test_sniff_from_http_proxy_tls12() {
        ...
        assert!(
            !captured.is_empty(),
            "TLS 1.2: Proxy should have captured ClientHello data"
        );
    ...
    async fn test_sniff_from_http_proxy_tls13() {
        ...
        assert!(
            !captured.is_empty(),
            "TLS 1.3: Proxy should have captured ClientHello data"
        );
